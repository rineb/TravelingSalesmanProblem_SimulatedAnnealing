...
public class SimulatedAnnealingLogarithmic {
    private Tour tour;
    ...
    public SimulatedAnnealingLogarithmic(Tour tour, double temperature, double coolingRate) {
        this.tour = tour;
    ...
    public Tour runIteration(int currentIteration) {
        ...
        temperatureChange(coolingRate, currentIteration);
    ...
    //Logarithmic function used to change temperature
    public void temperatureChange(double coolingRate, int currentIteration) {
        temperature = (coolingRate*100)/(Math.log(1+currentIteration));
    }
